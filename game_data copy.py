...
class GameData(metaclass=Singleton):
    def __init__(self):
        ...
        self.normal_font_path = pathlib.Path(r'.\JetBrainsMono-2.304\fonts\ttf\JetBrainsMono-Medium.ttf').resolve()
        self.bold_font_path = pathlib.Path(r'.\JetBrainsMono-2.304\fonts\ttf\JetBrainsMono--Bold.ttf').resolve()
